...
using FingerprintRecognitionV2.DataStructure.Util;
...
namespace FingerprintRecognitionV2.DataStructure
{
    ...
    public sealed class Deque<T> : IList<T>, IReadOnlyList<T>, System.Collections.IList
    {
        ...
        // original name: `AddToBack(T value)`
        {
            EnsureCapacityForOneElement();
            DoAddToBack(value);
        }
        ...
        // original name: `AddToFront(T value)`
        {
            EnsureCapacityForOneElement();
            DoAddToFront(value);
        }
